/*
  ...
  - The values [GERENTE] on the enum `Cargo` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Cargo_new" AS ENUM ('ADMIN', 'DONO', 'MEMBRO');
...
ALTER TABLE "usuarios" ALTER COLUMN "cargo" SET DEFAULT 'MEMBRO';
COMMIT;
